"""
Django settings for lovejoy_antique project.
...
SECRET_KEY = 'django-insecure-z+5969=u$xp1n-esi8plr%%)hvbb+fqzt(*-=l661r*hc=8(_&'
...
# Redirect users to the login page when they are not logged in
